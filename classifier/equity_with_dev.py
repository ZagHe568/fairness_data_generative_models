...
df_train_raw = pd.read_csv('../tgan/generated_data.csv', sep=',', engine='python')
df_train_raw = df_train_raw[:int(0.8*df_train_raw.shape[0])]
...
with tf.Session() as sess:
	...
	f1 = f1_score(Y_test[:, 1], pred_test, average='macro')
	print(f'total_test: {loss_total_test}, entropy_test: {loss_entropy_test}, accuracy_test: {accuracy_test}, imparity_test: {fairness_loss_test}, f1: {f1}')
	print("*****************")
